...
function Footer() {
  return (
    <>
       ...
       <div style={{color:'white'}} className='container mt-5 w-100'>
                     <div style={{height:'350px'}} className='container mt-5 w-100 p-5'>
                      <div className="footer-content d-flex justify-content-between">
                    <div style={{width:'400px'}} className="cart">
                       <h5 className='d-flex'><i style={{height:'30px'}} className="fa-solid fa-cart-shopping"></i>ShopSizzle</h5>
                    ...
                    <div className="contact">
                     ...
                     <a  href="https://react.dev/"  target='_blank' style={{textDecoration:'none',color:'white'}}><i style={{height:'35px'}} class="fa-brands fa-twitter fa-1x"></i></a>  
                     <a href="https://react.dev/"  target='_blank' style={{textDecoration:'none',color:'white'}}><i style={{height:'35px'}} class="fa-brands fa-instagram fa-1x"></i></a>  
                     <a href="https://react.dev/"  target='_blank' style={{textDecoration:'none',color:'white'}}><i style={{height:'35px'}} class="fa-brands fa-facebook fa-1x"></i></a>  
                     <a href="https://react.dev/"  target='_blank' style={{textDecoration:'none',color:'white'}}><i style={{height:'35px'}} class="fa-brands fa-linkedin fa-1x"></i></a>  
                     <a href="https://react.dev/"  target='_blank' style={{textDecoration:'none',color:'white'}}><i style={{height:'35px'}} class="fa-brands fa-github fa-1x"></i></a>  
